...
export const MyModal = ({ visible, onClose, profilePicturePath }: MyModalProps) => {
    ...
    return (
        <div id='modal' onClick={handleCLick} className='fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center hover:cursor-pointer group'>
